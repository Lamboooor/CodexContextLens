...
**Important disclosure:** Independent community tool, not affiliated with OpenAI. Context and quota values are recorded snapshots. Content shares measure visible characters, not exact token attribution. Current UI is primarily Chinese.
...
- `docs/screenshots/dashboard.png`: actual dashboard rendered with synthetic data.
- `docs/screenshots/sidebar.png`: narrow responsive view, synthetic data, not a screenshot of VS Code chrome.
- `docs/screenshots/hover.png`: card graphic generated by the runtime chart renderer, synthetic data.
